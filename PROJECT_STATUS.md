...
- URL: `https://dailytrade-backend.onrender.com`
...
- `VERCEL_DEPLOY.md`: detailed Vercel/Render/Supabase setup.
...
- [x] Frontend config points to current Render backend.
...
- Frontend pages returning 404 on Render is expected; use Vercel for HTML pages.
